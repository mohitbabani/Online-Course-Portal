...
{	$sql="select * from student where roll='".$_SESSION['blogin']."' AND passwords='".$_POST['cpass']."' LIMIT 1";
	$result=mysqli_query($conn,$sql);
	if(mysqli_num_rows($result)==1)
		{
		 $con=mysqli_query($conn,"update student set passwords='".$_POST['newpass']."'where roll='".$_SESSION['blogin']."'");
