...
{	$sql="select * from instructor where instructor_id='".$_SESSION['clogin']."' AND passwords='".$_POST['cpass']."' LIMIT 1";
	$result=mysqli_query($conn,$sql);
	if(mysqli_num_rows($result)==1)
		{
		 $con=mysqli_query($conn,"update instructor set passwords='".$_POST['newpass']."'where instructor_id='".$_SESSION['clogin']."'");
 ...
 <!-- MENU SECTION END-->
	 <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Instructor Change Password </h1>
                    </div>
                </div>
                <div class="row" >
